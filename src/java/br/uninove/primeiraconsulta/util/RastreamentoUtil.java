...
public class RastreamentoUtil {
    public static List<Rastreamento> getRastreamento(Prontuario prontuario, EstiloDeVida estiloDeVida, ExameFisico exameFisico) throws Exception {
        try {
    ...
    public static List<Rastreamento> getLogRastreamento(LogProntuario prontuario, LogEstiloDeVida estiloDeVida, LogExameFisico exameFisico) throws Exception {
        try {
            List<Rastreamento> listaRastreamento = new ArrayList<>();
    ...
    public static String getReferencias() throws Exception {
        try {
